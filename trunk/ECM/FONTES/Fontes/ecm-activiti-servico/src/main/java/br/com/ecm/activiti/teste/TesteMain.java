package br.com.ecm.activiti.teste;
...
import br.com.ecm.activiti.dominio.ProcessoInstancia;
import br.com.ecm.activiti.dominio.ProcessoInstanciaEntidade;
import br.com.ecm.activiti.dominio.TarefaInstancia;
import br.com.ecm.activiti.dominio.TarefaInstanciaEntidade;
...
//		parseTipoDocumentoDeserializable();
	...
	public static void parseTipoDocumentoDeserializable() {
		String uri = "http://170.10.200.224:8080/activiti-rest/service/runtime/process-instances/2764/variables/tipoDocumentoId/data";
...
//		FUNCIONAL
		/* HttpClient client = new HttpClient();
	     HttpMethod get = new GetMethod("http://170.10.200.224:8080/activiti-rest/service/runtime/process-instances/2764/variables/tipoDocumentoId/data");
	     ...
	     try {
	    	 ...
	    	 client.getState().setCredentials(new AuthScope("170.10.200.224", 8080, AuthScope.ANY_REALM), defaultcreds); 
	...
	public static void getVariablesFromHistoricProcess() {
		String uri = "http://170.10.200.224:8080/activiti-rest/service/history/historic-process-instances/305/variables";
		ResponseEntity<String> response = restTemplate.getForEntity(uri, String.class);
	...
	public static void postProcessosByVariables() {
		...
		String uri = "http://170.10.200.224:8080/activiti-rest/service/query/historic-process-instances";
...
//		PUT runtime/process-instances/{processInstanceId}/variables
		...
		String uri = "http://170.10.200.224:8080/activiti-rest/service/runtime/process-instances/701/variables";
