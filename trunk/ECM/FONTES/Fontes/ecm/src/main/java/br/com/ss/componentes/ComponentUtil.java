...
public class ComponentUtil {
	...
	/**
	 * se nao for informado update de componente faz update do proprio
	 * componente.
	 */
	...
	/**
	 * Retorna os nomes dos componentes a serem buscados pela classe
	 * org.primefaces.util.ComponentUtils do Primefaces. Uso:
	 * update="pnlObservacao pnlTotal"
	 * 
	...
	public String splitNameComponent(String componentNames) {
		if (StringUtil.notEmpty(componentNames)) {
			...
			String[] names = componentNames.split(" "); // splits by empty
														// spaces
