package br.fucapi.bpms.alfresco.servico.impl;
...
import br.fucapi.bpms.alfresco.dominio.UsuarioEntidade;
...
import br.fucapi.bpms.alfresco.util.ParseXML;
import br.fucapi.bpms.alfresco.util.XMLUtils;
...
public class AlfrescoServicoImpl implements AlfrescoServico, Serializable {
	...
	public Usuario autenticarUsuario(String login, String senha)
		...
		//Retorna excecao, impedindo que credenciais inválidas sejam lancadas para realizar o chamado com o retorno dos dados do usuario logado	
	...
	public void incluirUsuarioGrupo(String nome, String grupo) {
		String uri = MessageFormat.format(alfrescoproperties.getProperty("alfresco.server.usuario.grupo"), grupo,nome);
	...
	public void editarUsuario(String userName, String firstName,
		...
		headers.set("Content-type", "application/json");
		  ...
		  enable + "\",\"lastName\":\"" + lastName + "\",\"email\":\"" + email
		  + "\"}";
	...
	public void atualizarSenha(String userName, String password) {
		...
		String uri = MessageFormat.format(alfrescoproperties.getProperty("alfresco.server.usuario.senha"), userName);
