...
public class StringUtil {
	...
	/**
	 * Retorna String com apenas a primeira letra em mai�sculo. Ex: RICARDO DA
	 * COSTA -> Ricardo da Costa
	 * 
	 * @param line
	 * @return String
	 */
	...
	public static String toLatin1(String tx) {
		...
		return tx.replaceAll("\\�", "+").replaceAll("�", "\"")
	...
	public static String getAcentosFromHtmlToAscii(String texto) {
		return texto.replaceAll("\\&oacute;", "ó")
				.replaceAll("\\&aacute;", "á").replaceAll("\\&eacute;", "é")
				.replaceAll("\\&iacute;", "í").replaceAll("\\&uacute;", "ú")
				.replaceAll("\\&ccedil;", "ç").replaceAll("\\&atilde;", "ã")
				.replaceAll("\\&otilde;", "õ");
	}
	...
	/**
	 * Recupera a string representada pelo objeto informado, ou "", caso o
	 * objeto esteje nulo.
	 * 
	 * @param ob
	 * @return Stirng
	...
	/**
	 * Retorna um vetor de strings da string informada fazendo split utilizando
	 * os espa�oes em branco da mesma.
	 * 
	 * @param str
	 * @return String[]
	 */
	...
	public static String formatarNumeroTelefone(String numeroFone) {
		...
		suf = fone.substring(IntegerConstantUtils.SEIS,
				IntegerConstantUtils.DEZ);

		fone = String.format("(%02d) %02d-%04d", new Integer(ddd), new Integer(
				pref), new Integer(suf));
		return fone;
	}
