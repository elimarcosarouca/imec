...
import br.fucapi.ads.modelo.utils.Utils;
...
public class VariavelPublicarDocumento extends Variavel {
	...
	public void tratarAtributosParaSalvar(List<Usuario> aprovadoresTarget, List<Usuario> concensosTarget) {
		...
		this.dataNotificacao = Utils.gerarDataNotificacao(this.dataVencimento, this.notificarVencimento);
	}
...
//				this.setEmailAprovadores( var.getValue().toString());
	...
	public Map<String, Object> converterVariaveis() {
		...
		params.put("listaAprovadores", this.getAprovadores());
		params.put("emailAprovadores", this.getEmailAprovadores());
